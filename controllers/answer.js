...
const getSingleAnswer = asyncErrorWrapper( async(req,res,next) => {
    ...
    .populate({
        path: "question", // ref name
        select: "title" //only title prints
    })
    .populate({
        path: "user",
        select: "name profile_image" //multiple filter for print
    });
...
const deleteAnswer = asyncErrorWrapper( async(req,res,next) => {
    ...
    question.answerCount = question.answers.length; // update answer count of question
